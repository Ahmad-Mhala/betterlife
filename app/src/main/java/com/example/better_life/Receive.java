...
public class Receive extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    EditText mFullName,mDescription,rphonenumber;
    Button mSubmitBtn;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rphonenumber=findViewById(R.id.reciverphonenumber);
    ...
    public void onLocationChanged(@NonNull Location location) {
        ...
        mSubmitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String phonenumber=rphonenumber.getText().toString();
                ...
                CollectionReference collectionReference = fStore.collection("Donation details");

                GeoPoint geoPoint = new GeoPoint(location.getLatitude(),location.getLongitude());
                Map<String,Object> user = new HashMap<>();
                user.put("timestamp", FieldValue.serverTimestamp().toString());
